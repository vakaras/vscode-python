...
## 2021.8.4 (23 August 2021)

### Fixes

1. Removing Jupyter extension from the extension pack since it not web enabled.
   ([#17080](https://github.com/Microsoft/vscode-python/issues/17080))
